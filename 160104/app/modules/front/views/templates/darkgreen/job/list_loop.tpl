		...
		<table class="dynamicTable fixedHeaderColReorder table">
			...
			<tbody>
				...
				<tr class="gradeX">
					...
					<a href="{$base_url_admin}{$form.control}/index/?id={$set.id}&option=edit" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a>
					<!--
					<a data-toggle="confirmation" data-placement="left" href="javascript:void(0)" data-href="{$base_url_admin}{$form.control}/del/?id={$set.id}&option=list" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
					-->

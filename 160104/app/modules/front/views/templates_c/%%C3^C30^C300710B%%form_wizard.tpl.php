<?php /* Smarty version 2.6.25, created on 2016-01-04 13:50:00
         compiled from employee/form_wizard.tpl */ ?>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="tab2-4">
					<div class="row">
						...
						<div class="col-md-9">
							...
							<textarea id="textDescription" class="wysihtml5 form-control" style="width: 96%;"
							rows="5">Lorem ipsum dolor sit amet, consectetuer
				...
				<div class="tab-pane" id="tab3-4">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing
						elit. Duis ultrices libero vel massa egestas
						facilisis. Mauris convallis augue nec dolor
						dignissim vestibulum. Praesent imperdiet
						elit posuere arcu posuere consectetur.
						Morbi dignissim eleifend nibh, eget tincidunt
						nibh dignissim hendrerit. Cras iaculis
						congue lorem, eget gravida augue vehicula
						sed. Nam lorem sem, consectetur ac tempus
						quis, consectetur ut lectus. In bibendum
						luctus pharetra. Morbi lacinia sem sem.

<?php
/**
 * Controllers Job title Setting General config
...
class JobtitlesettingController extends Zend_Controller_Action {
    ...
    function listAction(){
    	...
    	$cbx = new Zend_Config_Ini(APPLICATION_PATH.'/configs/jobs.ini', 'EMPLOYEE');
    	$preset_general = $cbx->toArray();
    	$general = $preset_general['general'];
